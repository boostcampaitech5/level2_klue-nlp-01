...
REF_SENT = {26: 'The relation is "The place where the specified person died".', 
9:'The relation is "The total number of members that are affiliated in the specified organization".',
22:'The relation is "The date when the specified organization was dissolved".',
23:'The relation is "A school where the specified person attended".',
29:'The relation is "The religion in which the specified person believes".'
}
